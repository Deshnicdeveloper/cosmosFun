...
export const decks: Deck[] = [
  ...
  },
  {
    ...
    words: [
      ...
      m("Mission Impossible"), m("Home Alone"), m("Forrest Gump"),
      m("Squid Game"),
      h("The Godfather"), h("Inception"), h("The Truman Show"),
      h("Black Mirror"), h("The Silence of the Lambs"), h("Groundhog Day"),
      h("Citizen Kane"), h("2001: A Space Odyssey"), h("Parasite"),
      h("Pulp Fiction"), h("The Blair Witch Project"),
    ],
  },
  {
    id: "animals",
  ...
  },
  {
    ...
    words: [
      ...
      m("Christopher Columbus"), m("Julius Caesar"), m("Bob Marley"),
      m("Bruce Lee"), m("Mahatma Gandhi"),
      h("Isaac Newton"), h("Marie Curie"), h("Nikola Tesla"),
      h("Vincent van Gogh"), h("Beethoven"), h("Genghis Khan"),
      h("Nelson Mandela"), h("Pablo Picasso"), h("Socrates"),
      h("Joan of Arc"), h("Alexander the Great"),
    ],
  },
  {
    id: "occupations",
  ...
  },
  {
    ...
    words: [
      ...
      h("Petra"), h("Easter Island"), h("Angkor Wat"),
    ],
  },
  {
    id: "food-drinks",
